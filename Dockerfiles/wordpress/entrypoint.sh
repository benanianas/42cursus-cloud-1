...
wp core install --path=/var/www/wordpress --url=$HOST_IP --title=abenani --admin_user=$WP_USER --admin_password=$WP_PASS --admin_email=abenani@student.1337.ma --allow-root --quiet
fi
